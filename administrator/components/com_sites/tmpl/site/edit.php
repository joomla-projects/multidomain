...
?>
<form action="<?php echo Route::_('index.php?option=com_sites&layout=' . $layout . $tmpl . '&idSite=' . $this->item->idSite); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
