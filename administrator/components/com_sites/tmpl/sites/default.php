              ...
              <span id="filteredBy"><?php echo Text::_('JGLOBAL_FILTERED_BY'); ?></span>
                ...
                <th scope="col" class="w-5">
								...
								<th scope="col" class="w-1 d-none d-md-table-cell">
									<?php echo HTMLHelper::_('searchtools.sort', 'JGRID_HEADING_ID', 'a.idSite', $listDirn, $listOrder); ?>
								</th>
							</tr>
						</thead>
            <tbody<?php if ($saveOrder) : ?> class="js-draggable" data-url="<?php echo $saveOrderingUrl; ?>" data-direction="<?php echo strtolower($listDirn); ?>" data-nested="false"<?php endif; ?>>
							<?php foreach ($this->items as $i => $item) :
                $canEdit          = $user->authorise('core.edit',       'com_sites.site.' . $item->idSite);
                $canCheckin       = $user->authorise('core.manage',     'com_checkin') || $item->checked_out == $userId || is_null($item->checked_out);
                $canEditOwn       = $user->authorise('core.edit.own',   'com_sites.site.' . $item->idSite) && $item->created_by == $userId;
                $canChange        = $user->authorise('core.edit.state', 'com_sites.site.' . $item->idSite) && $canCheckin;
                  ?>
								<tr class="row<?php echo $i % 2; ?>" data-draggable-group="0">
									<td class="text-center">
									<?php echo HTMLHelper::_('grid.id', $i, $item->idSite, false, 'cid', 'cb', $item->title); ?>
									</td>
                  <td class="text-center d-none d-md-table-cell">
                    ...
                    <div class="break-word">
                          ...
                          <a href="<?php echo Route::_('index.php?option=com_sites&task=site.edit&idSite=' . $item->idSite); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape($item->title); ?>">
